      ...
      >
        <div className=" p-6">
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            <button className="px-8 py-3 rounded-full bg-white text-black text-base font-semibold shadow-lg transition-all duration-300 hover:bg-gray-100 hover:shadow-xl transform hover:scale-105">
              Start Free Trial
            </button>
          </div>
        </div>
      ...
      >
        ...
        <div className=" p-6 ">
          ...
          <div className="flex flex-col gap-3">
            <button className="px-6 py-3 rounded-full bg-white text-black text-sm font-semibold shadow-lg transition-all duration-300">
              Start Free Trial
            </button>
            <button className="px-6 py-3 rounded-full border border-white/30 text-white text-sm font-medium transition-all duration-300">
              Watch Demo
            </button>
          </div>
        </div>
